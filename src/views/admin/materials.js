 ...
 * Mengelola bahan ajar, ringkasan teori matematika dengan formula KaTeX presisi,
 * dan berkas modul ajar.
 */
      ...
      <div style="max-width: 1100px; margin: 0 auto;">
        ...
        <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 24px; flex-wrap: wrap; gap: 14px;">
          <div>
            ...
            <p style="font-size: 0.85rem; color: var(--white-muted);">
              Kelola bahan ajar, ringkasan teori matematika, rumus KaTeX presisi, dan berkas ajar.
            </p>
          </div>
        ...
        <div id="add-material-modal" class="glass-panel" style="display: none; padding: 24px; margin-bottom: 24px; border-color: var(--teal-primary);">
          ...
          <form id="form-create-material">
            ...
            <div class="form-group">
              <label class="form-label">Uraian Materi & Formula Matematika (Gunakan delimiter $...$ untuk rumus)</label>
              <textarea id="mat-content" class="form-textarea" rows="5" placeholder="Contoh: Pada segitiga siku-siku berlaku rumus $c = \\sqrt{a^2 + b^2}$ dengan c adalah hipotenusa." required></textarea>
            </div>
            ...
            <div class="form-group">
              <label class="form-label">URL Berkas Lampiran / PDF (Opsional)</label>
        ...
        <div id="materials-list" style="display: flex; flex-direction: column; gap: 16px;">
          ...
          <div class="glass-panel" style="padding: 20px;">
            <div style="display: flex; justify-content: space-between; align-items: flex-start; margin-bottom: 10px;">
              <div>
                <span class="badge badge-teal" style="margin-bottom: 6px;">Kelas 8A • Geometri</span>
                <h3 style="font-size: 1.15rem; color: var(--white-crisp);">Teorema Pythagoras dan Segitiga Siku-Siku Khusus</h3>
              </div>
              <span style="font-size: 0.78rem; color: var(--white-muted);">16 Agustus 2026</span>
            </div>
            
            <div class="katex-render-area" style="font-size: 0.92rem; color: var(--white-crisp); margin-bottom: 12px; line-height: 1.6;">
              Hubungan panjang sisi pada segitiga siku-siku: $$c^2 = a^2 + b^2 \iff c = \sqrt{a^2 + b^2}$$
              Perbandingan sisi dengan sudut istimewa $30^\circ : 60^\circ : 90^\circ$ adalah $1 : \sqrt{3} : 2$.
            </div>
            ...
            <div style="display: flex; justify-content: space-between; align-items: center; border-top: 1px solid var(--glass-border); padding-top: 12px;">
              <span style="font-size: 0.8rem; color: var(--teal-primary);">📎 Modul PDF Terlampir</span>
          ...
          <div class="glass-panel" style="padding: 20px;">
            <div style="display: flex; justify-content: space-between; align-items: flex-start; margin-bottom: 10px;">
              <div>
                <span class="badge badge-teal" style="margin-bottom: 6px;">Kelas 7A • Aljabar</span>
                <h3 style="font-size: 1.15rem; color: var(--white-crisp);">Sistem Persamaan Linear Satu Variabel (PLSV)</h3>
              </div>
              <span style="font-size: 0.78rem; color: var(--white-muted);">12 Agustus 2026</span>
            </div>
            ...
            <div style="display: flex; justify-content: space-between; align-items: center; border-top: 1px solid var(--glass-border); padding-top: 12px;">
              <span style="font-size: 0.8rem; color: var(--teal-primary);">📎 Lembar Kerja Terlampir</span>
              <button class="btn btn-secondary btn-sm">Edit Materi</button>
            </div>
          </div>
    ...
    if (form) {
      form.addEventListener('submit', async (e) => {
        ...
        try {
          ...
          store.showToast('Materi pembelajaran berhasil diterbitkan.', 'success');
          form.reset();
          hideModal();
        } catch (err) {
